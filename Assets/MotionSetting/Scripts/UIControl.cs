...
{
    public List<MotionInfo> MotionList = new List<MotionInfo>();
}
...
public class UIControl : MonoBehaviour
{
    ...
    public Text player1Button;
    public Text player2Button;
    public Text[] player1ParaText = new Text[paraCount];
    public Text[] player2ParaText = new Text[paraCount];
    ...
    public Text player1Confirm;
    public Text player2Confirm;
