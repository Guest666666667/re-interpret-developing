...
Shader "Shadero Customs/Aura Light 1"
{
Properties
{
...
_ShadowLight_Precision_1("_ShadowLight_Precision_1", Range(1, 32)) = 4.048
...
float4 OperationBlend_1 = OperationBlend(NewTex_1, OperationBlend_2, _OperationBlend_Fade_1); 
