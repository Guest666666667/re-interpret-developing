...
public class readTxt : MonoBehaviour {
    ...
    void Update()
    {
        ...
        for (int i = 0; i < musicPoint.Count; i++)
        {
            ...
            if ((((boneSeq[i] == 0 || boneSeq[i] == 7 || boneSeq[i] == 8) && totalTime >= (musicPoint[i] - 0.5f / 0.5f)) || (!(boneSeq[i] == 0 || boneSeq[i] == 7 || boneSeq[i] == 8) && totalTime >= (musicPoint[i] - 0.5f))) && actionJudge[i] == false) //双键慢动作
            {
